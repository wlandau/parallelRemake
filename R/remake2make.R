#' @title Function \code{remake2make}
...
#'     )
#' Then, I call remake2make(stages) to produce the approprate Makefile. 
...
#'       "finish"
#'     )
#' @param makefile Path to output Makefile.
remake2make = function(stages, makefile = "Makefile"){
  stages = name_stages(stages)
  sink(makefile)
  cat("# Generated by remake2make() on", as.character(Sys.time()), "\n\n")
